...
|-----------------|-----------------|-----------------|---------------------|
| Rośleń             | 180150     | 14.04.2023          | wpisać                      |
...
# Zadanie 1 - Algorytmy generowania reguł

## 1. Dobór innego podzbioru cech

Dla zbioru danych hiring dobiorę inny zestaw cech branych pod uwagę w tworzeniu zbiorów przybliżonych oraz cech decyzyjnych. Wybrałem w tym celu 2 cechy: French oraz Reference.
...
Zastosowanie wyżej wymienionych cech spowodowało powstanie 5 klas abstrakcji oraz 4 reguł decyzyjnych. Błąd klasyfikacji w tym wypadku wyniósł 25%, a więc większy niż w przypadku zastosowania cech Diploma oraz Experience.

## 2. Zastosowanie innego zbioru wejściowego oraz algorytmu generowania reguł decyzyjnych

Teraz wykonam klasyfikację w oparciu o inny zbiór danych: titanic, w którego skład wchodzą 3 cechy opisowe oraz jedna cecha decyzyjna: survived mówiąca o tym czy dana osoba przeżyła katastrofę czy też nie. Do klasyfikacji postanowiłem uwzględnić wszystkie 3 cechy: class, age oraz sex. Do generowania reguł decyzyjnych użyję tym razem funkcji RI.CN2Rules.RST() z parametrem K = 2.
...
Zastosowanie wyżej wymienionych cech spowodowało powstanie 12 klas abstrakcji oraz 11 reguł decyzyjnych. Błąd klasyfikacji w tym wypadku wyniósł 20%.
...
# Zadanie 2 - Macierz rozróżnialności i redukt

Dla zbioru hiring cechy Experience i Diploma lub Experience i Reference są wystarczające do rozróżnienia obiektów różnych klas. Podzbiory te można więc nazwać reduktami.

Teraz wygeneruję macierz rozróżnialności dla zbioru składającego się z 10 losowo wybranych obiektów ze zbioru titanic.
...
#decision.table
```
Dla powyższego zbioru titanic cechy class i sex są wystarczające do rozróżnienia obiektów różnych klas. Podzbiór składający się z tych cech można więc nazwać reduktem.
